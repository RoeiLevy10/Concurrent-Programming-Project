...
class PlayerTest {
    ...
    void penalty()
    {
        //after penalty expect cameBackFromPenalty to be true;
        ...
        assertEquals(expectedBool, player.getCameBackFromPenalty());
    }

    @Test
    void terminate()
    {
        //after terminate() expect terminate to be true;
        boolean expectedBool = true;
        ...
        // check that the boolean was changed correctly
        assertEquals(expectedBool, player.getBoolTerminate());
    }
}